...
//                 theta_hom = theta_f_right + (theta_i - theta_f_right) * ((1 + sin(homing_w * dt + M_PI / 2.0)) / 2.0);
...
//                 // Send theta of homing sequence
//                 //this eqn is verified; works for both when theta_f is greater than or lower than theta_i 
//                 theta_hom = theta_f_left + (theta_i - theta_f_left) * ((1 + sin(homing_w * dt + M_PI / 2.0)) / 2.0);
//                 cout << theta_hom << ";";
...
//                 // Send theta of homing sequence
//                 //this eqn is verified; works for both when theta_f is greater than or lower than theta_i 
//                 theta_hom = ktheta_f_right + (theta_i - ktheta_f_right) * ((1 + sin(homing_w * dt + M_PI / 2.0)) / 2.0);
//                 cout << theta_hom << ";";
...
//                 // Send theta of homing sequence
//                 //this eqn is verified; works for both when theta_f is greater than or lower than theta_i 
//                 theta_hom = ktheta_f_left + (theta_i - ktheta_f_left) * ((1 + sin(homing_w * dt + M_PI / 2.0)) / 2.0);
//                 cout << theta_hom << ";";
...
// // ===== Send 3rd hip motor's ID (RIGHT KNEE) =================================================================== //
            ...
            ktheta_d_right = (M_PI/180) * 2.2*(ka0 + ka1*cos(t*w) + kb1*sin(t*w) + 
...
//             ktheta_d_left = (-M_PI/180) * 1.161*(ka0 + ka1*cos((t-b)*w) + kb1*sin((t-b)*w) + 
