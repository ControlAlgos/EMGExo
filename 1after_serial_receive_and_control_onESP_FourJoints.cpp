...
int step = 0;
int num_of_motors;
int motor_id[4];  //change 10 to however many motors you want to connect to ESP
...
void loop() {
  ...
  int kp = 100;  //set back to 495, 420
  ...
  //***********Motor ID 1 Feedback**********//
  mySerial2.printf("%.4f pos;", motor_state[1]); //print motor feedback position (encoder)
  //mySerial2.printf("%.4f;", motor_state[1]);
  mySerial2.printf("%.4f vel;", motor_state[2]); //print motor feedback velocity
  mySerial2.printf("%.4f cur;", motor_state[3]); //print motor feedback current (torque)
  //mySerial2.printf("%.4f;", motor_state[0]); //print motor ID
