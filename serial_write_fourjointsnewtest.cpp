...
float a6 = -0.2732;
float b6 = 0.06696;
float w  = 1.2; //0.1879 * 10;  //removed *10 that was there for testing
...
int main() {
    ...
    SerialPC writePort;
    char write_port_num[] = "COM8"; // CP210x USB to UART Bridge (COM3) Option on computer
    int baudrate = 115200;
    ...
    const int NUM_OF_MOTORS = 4;  //just the two hip motors for now
    int id[NUM_OF_MOTORS + 1] = {NUM_OF_MOTORS, 1, 2, 3, 4};  //right (hip), left (hip), right (knee), Left(knee) 
